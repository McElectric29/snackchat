...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let request = URLRequest(url: URL(string: "https://assistant-chat-us-south.watsonplatform.net/web/public/706ce89b-6e69-4286-9e8d-28a42e8792c6")!)
    ...
    func configureDefaults() {
        // Create default data
        let defaults = [
            ClassResult(className: "Redbull", score: 0.6, typeHierarchy: "Cal 110, Sugar 27g"),
            ClassResult(className: "Boba", score: 0.5, typeHierarchy: "Cal 230, Sugar 12g"),
            ClassResult(className: "Apple", score: 0.5, typeHierarchy: "Cal 95, Sugar 19g"),
            ClassResult(className: "Banana", score: 0.5, typeHierarchy: "Cal 105, Sugar 14g")
        ]
